...
QUnit.test("ЗАДАЧА 03. checkCardNumber(nstr) проверяет правильность номера карты", function(assert){
	...
	assert.deepEqual(checkCardNumber("2341 8901 2310 7895"), false, "Не выполнено checkCardNumber(2341 8901 2310 7895) == false")
	assert.deepEqual(checkCardNumber("1111 1111 1111 1111"), false, "Не выполнено checkCardNumber(1111 1111 1111 1111) == false")
});